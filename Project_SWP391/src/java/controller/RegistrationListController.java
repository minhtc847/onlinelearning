 ...
 * @author ADMIN
 */
@WebServlet(name="RegistrationListController", urlPatterns={"/RegistrationList"})
public class RegistrationListController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        List<RegistrationList> listP = dao.pagingRegistrationList(index);
        ...
        request.setAttribute("listRegistration", listP);
