...
public class viewLessonDetail extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try ( PrintWriter out = response.getWriter()) {
            ...
            String actionLesson = request.getParameter("actionLesson");
            request.setAttribute("actionLesson", actionLesson);
            ...
            chapters chapter = daoLesson.getChapterByLessonID(lesson_id);
