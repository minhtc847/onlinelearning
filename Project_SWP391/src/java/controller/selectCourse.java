...
public class selectCourse extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet selectCourse at " + request.getContextPath () + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    } 
    ...
    throws ServletException, IOException {
        ...
        RegistrationDAO daoR = new RegistrationDAO();
        List<Course> listR = daoR.getAllCourse();
        request.setAttribute("listCourse", listR);
