 ...
 * @author ADMIN
 */
@WebServlet(name="jointimeController", urlPatterns={"/jointime"})
public class jointimeController extends HttpServlet {
    ...
    throws ServletException, IOException {
        ...
        String timeToParam = request.getParameter("jointime");
        Date jointime = null;        
        List <RegistrationList> listJ;
        ...
        if (timeToParam != null && !timeToParam.isEmpty() && !timeToParam.equals("-1")) {
            try {
                ...
                jointime = new Date(Long.parseLong(timeToParam));
        ...
        if (jointime == null){
            listJ = dao.RegitrationList();
        } else {
            listJ = dao.getRegitrationListByJoinTimel(jointime);
        }
        ...
        request.setAttribute("listRegistration",listJ);
